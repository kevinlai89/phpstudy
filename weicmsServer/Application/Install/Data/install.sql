...
-- ----------------------------
INSERT INTO `wp_addons` VALUES ('167', 'Cms', '微信小程序报价平台', '微信小程序报价平台内容管理系统', '1', 'null', '翔鹰', '0.1', '1474906191', '1', '0', '2', '1');
INSERT INTO `wp_addons` VALUES ('168', 'Feedback', '用户反馈', '', '1', 'null', '翔鹰', '0.1', '1475997576', '1', '0', null, '1');
...
INSERT INTO `wp_cms` VALUES ('2', '学微信小程序开发---从开发CMS系统学起', '101', '实践中学习是开发者最好最快的学习方法。本教程将和大家从零开始一步一步搭建微信小程序报价平台系统，每个章节都会涉及到不同的知识点，等教程学习完你不但掌握了小程序开发全部知识，同时还拥有一个完整作品的开发经验！ ----weiphp的翔鹰', '1474908960');
INSERT INTO `wp_cms` VALUES ('3', '【圆梦云出品】全网首个微信小程序开发视频教程', '103', '     这几天微信小程序的消息一直在刷屏，大家都比较兴奋，仿佛又看到一个新大陆，新金坑。奈何能参与内测的又少之又少。我们WeiPHP团队作为专业的微信第三方服务商，自然也是伸长脖子到处观望，并且第一时间跟进和研读各种渠道来的信息。由于消息太过散乱，过程中遇到种坑各种问题。现在是时候结合自身的实践，出个视频和大家分享下了，期望让大家不再绕弯，快速进入开发中来。当然了，大家都是在同一起跑线上，相对行业里的一些专家大牛们，我们可能也只是迷途小学生而已，如果有不对的地方也欢迎在我们社区（bbs.163.com）里指出来，我们愿望和大家一起进步', '1474909056');
INSERT INTO `wp_cms` VALUES ('4', '【weiphp新产品】梦云社区强势上线 开启移动社区新时代', '110', '经过weiphp团队历经数月精心筹备的梦云社区今天强势上线啦！\r\n在这里您看到的每个细节都倾注了我们不懈的努力，\r\n在这里有一群与您一样热心向上的友友，等待与您分享交流，\r\n在这里有最专业的梦云社区客服，随时准备为您答疑解惑，助您工作无忧，\r\n这里不仅可以发帖、回帖、查看动态，还支持PC和手机同步使用。\r\n融合了“手机+PC+APP”多模式，实现了社区一体化；从此手机+PC+APP真的“联姻”了。\r\n梦云社区链接：http://bbs.163.com/\r\n官方微信公众号：yuanmengyunkeji', '1474942170');
...
INSERT INTO `wp_feedback` VALUES ('8', '翔鹰', '0,2', '1', '2', '100', '1', '1476002313');
INSERT INTO `wp_feedback` VALUES ('7', '翔鹰', '0,2', '1', '2', '100', '1', '1476002275');
INSERT INTO `wp_feedback` VALUES ('10', '翔鹰', '0,1,2', '0', '0', '41', '1', '1483713658');
INSERT INTO `wp_feedback` VALUES ('11', '翔鹰', '2', '1', '0', '51', '1', '1483714400');
...
INSERT INTO `wp_plugin` VALUES ('58', 'Cascade', '级联菜单', '支持无级级联菜单，用于地区选择、多层分类选择等场景。菜单的数据来源支持查询数据库和直接用户按格式输入两种方式', '1', 'null', '翔鹰', '0.1', '1398694996', '0', null, '1');
INSERT INTO `wp_plugin` VALUES ('120', 'DynamicSelect', '动态下拉菜单', '支持动态从数据库里取值显示', '1', 'null', '翔鹰', '0.1', '1435223177', '0', null, '1');
INSERT INTO `wp_plugin` VALUES ('125', 'News', '图文素材选择器', '', '1', 'null', '翔鹰', '0.1', '1439198046', '0', null, '1');
INSERT INTO `wp_plugin` VALUES ('127', 'DynamicCheckbox', '动态多选菜单', '支持动态从数据库里取值显示', '1', 'null', '翔鹰', '0.1', '1464002908', '0', null, '1');
INSERT INTO `wp_plugin` VALUES ('128', 'Prize', '奖品选择', '支持多种奖品选择', '1', 'null', '翔鹰', '0.1', '1464060178', '0', null, '1');
INSERT INTO `wp_plugin` VALUES ('129', 'Material', '素材选择', '支持动态从素材库里选择素材', '1', 'null', '翔鹰', '0.1', '1464060381', '0', null, '1');
